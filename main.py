...
def results(nickname, level, rating):
    return f'''<!doctype html>
                        ...
                        <title>Колонизация</title>
                          ...
                          <body>
                            <h1 class="mars">Результаты отбора</h1>
                            <h2>Претендент на участие в миссии: {nickname}</h2>
                            <div class="alert alert-warning" role="alert">Ваш рейтинг после {level} этапа отбора:</div>
                            <div class="alert alert-success" role="alert">{rating}</div> 
                            <div class="alert alert-danger" role="alert">Удачи в следующих этапах!</div>                          
                          </body>
                        </html>'''
